...
class Milvus:
    def __init__(self):
        ...
        self.collection_name = "facial_embeddings_v2"
    ...
    def dumpToElasticSearch(self,idx,image_link):
        ...
        data = {"date": c_time, "image_id":idx, "url":image_link}
    ...
    def insert(self,entities,image_link):
        ...
        try:
            ...
            try:
                idx = collection.insert([[entities]])._primary_keys[0]
        ...
        try:
            ...
            for raw_result in results:
                for result in raw_result:
                    if result.distance <= 85: #(threshold to select similar images)
                        #print(result.id)
